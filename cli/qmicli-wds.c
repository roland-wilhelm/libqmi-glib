...
get_dun_call_ready(QmiClientWds *client, GAsyncResult *res)
{
    ...
    g_print("\tTx bytes ok: %lld\n", (unsigned long long)qmi_wds_get_dun_call_output_get_tx_bytes_ok(output));
    g_print("\tRx bytes ok: %lld\n", (unsigned long long)qmi_wds_get_dun_call_output_get_rx_bytes_ok(output));
...
get_pkt_stat_ready(QmiClientWds *client, GAsyncResult *res)
{
    ...
    g_print("\tTx bytes ok: %lld\n", (unsigned long long)qmi_wds_get_pkt_stat_output_get_tx_bytes_ok(output));
    g_print("\tRx bytes ok: %lld\n", (unsigned long long)qmi_wds_get_pkt_stat_output_get_rx_bytes_ok(output));
